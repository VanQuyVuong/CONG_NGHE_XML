...
namespace BAI6_VANQUYVUONG
{
    public partial class Form1 : Form
    {
        ...
        String pathItem = "Data\\iterm.xml";
        ...
        private void lblCustomer_Click_1(object sender, EventArgs e)
        {

        }

        private void listItemsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            listItem();
        }

        private void cboOrder_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            viewOrderDetail(cboOrder.Text);
        }

        private void cboCCode_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            agreItemOrdered(cboCCode.Text);
        }

        private void lblCustomer_Click_2(object sender, EventArgs e)
        {
            listCustomer();
        }
        ...
        void agreItemOrdered(String ccode)
        {
            ...
            lblTotal.Text = "Tổng: " + total.ToString() + " triệu đồng";
